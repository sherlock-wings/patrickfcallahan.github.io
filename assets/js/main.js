...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Observe timeline items, skill categories, and project cards
...
console.log('%cInterested in how this site was built? Check out the source on GitHub!', 'font-size: 12px;');
